...
#    set title "Between orbitals 1-3"
    ...
    set output "orbs-scan-1-3.pdf"

    plot 'orbs-scan-1-3.txt' u 1:2 w l t 'Jacobi rotation' ls 1, '' u 1:3 w l t 'v2DM + Jacobi rotation' ls 2
