...
#    set title "Between orbitals 2-3"
    ...
    set output "orbs-scan-2-3.pdf"

    plot 'orbs-scan-2-3.txt' u 1:2 w l t 'Jacobi rotation' ls 1, '' u 1:3 w l t 'v2DM + Jacobi rotation' ls 2
